...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/19 10:58:54 by carlfern          #+#    #+#             */
/*   Updated: 2023/02/19 12:21:13 by carlfern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	varstat[fd] = ft_get_varstat(fd, varstat[fd]);
	if (!varstat[fd])
		return (NULL);
	line = ft_get_line(varstat[fd]);
	varstat[fd] = ft_update_varstat(varstat[fd]);
	return (line);
}
